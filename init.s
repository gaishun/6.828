...
.LM8:
	leaq	edata(%rip), %rdi
	leaq	end(%rip), %rdx
	.stabn	68,0,26,.LM9-.LFBB2
.LM9:
	subq	$8, %rsp
	.cfi_def_cfa_offset 16
	.stabn	68,0,32,.LM10-.LFBB2
.LM10:
	xorl	%esi, %esi
	subq	%rdi, %rdx
	call	memset@PLT
...
# 73 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,75,.LM23-.LFBB3
.LM23:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,76,.LM24-.LFBB3
.LM24:
	movl	%esi, %edx
	movq	%rdi, %rsi
	leaq	.LC3(%rip), %rdi
